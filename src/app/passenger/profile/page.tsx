...
export default function PassengerProfilePage() {
    ...
    const [profileData, setProfileData] = useState({
        ...
        emergencyContact1: 'Husband - +91 98765 11111',
        emergencyContact2: 'Mother - +91 98765 22222',
        preferredDriverType: 'Any Verified Driver',
        defaultPickup: 'Home - Sector 15, Noida',
        safetyFilters: {
            verified: true,
            alcoholTested: true,
        }
        ...
        <div className={styles.container}>
            ...
            <main className={styles.main}>
                ...
                <div className={styles.profileHeader}>
                    ...
                    <span className={styles.roleLabelPassenger}>Passenger</span>
                </div>
                ...
                <Card padding="medium" className={styles.sectionCard}>
                    ...
                    <div className={styles.infoGrid}>
                        ...
                        <div className={styles.infoItem}>
                            <span className={styles.infoLabel}>Alternate Phone</span>
                ...
                <Card padding="medium" className={styles.sectionCard}>
                    ...
                    <div className={styles.emergencyContacts}>
                        <h4 className={styles.subTitle}>Emergency Contacts</h4>
                    ...
                    <div className={styles.geoFenceInfo}>
                        <h4 className={styles.subTitle}>Geo-fencing Preferences</h4>
                        <div className={styles.geoItem}>
                            <span className={styles.geoIcon}>📍</span>
                            <div>
                                <span className={styles.geoLabel}>Route Tracking</span>
                                <span className={styles.geoValue}>Active - Real-time alerts enabled</span>
                            </div>
                        </div>
                        <div className={styles.geoItem}>
                            <span className={styles.geoIcon}>⚠️</span>
                            <div>
                                <span className={styles.geoLabel}>Deviation Alerts</span>
                                <span className={styles.geoValue}>Notify when 200m+ off route</span>
                            </div>
                        </div>
                    </div>
                    <button
                ...
                <Card padding="medium" className={styles.sectionCard}>
                    <div className={styles.sectionHeader}>
                        <h3 className={styles.sectionTitle}>Trip Preferences</h3>
                        <button
                            className={styles.editBtn}
                            onClick={() => setEditSection('trip')}
                        >
                            Edit
                        </button>
                    </div>
                    <div className={styles.infoGrid}>
                        <div className={styles.infoItem}>
                            <span className={styles.infoLabel}>Preferred Driver Type</span>
                            <span className={styles.infoValue}>{profileData.preferredDriverType}</span>
                        </div>
                        <div className={styles.infoItem}>
                            <span className={styles.infoLabel}>Default Pickup</span>
                            <span className={styles.infoValue}>{profileData.defaultPickup}</span>
                        </div>
                    </div>
                    <div className={styles.safetyFilters}>
                        <h4 className={styles.subTitle}>Safety Filters</h4>
                        <div className={styles.filterItem}>
                            <span className={profileData.safetyFilters.verified ? styles.filterActive : styles.filterInactive}>
                                {profileData.safetyFilters.verified ? '✅' : '⬜'} Verified Drivers Only
                            </span>
                        </div>
                        <div className={styles.filterItem}>
                            <span className={profileData.safetyFilters.alcoholTested ? styles.filterActive : styles.filterInactive}>
                                {profileData.safetyFilters.alcoholTested ? '✅' : '⬜'} Alcohol-Tested Drivers
                            </span>
                        </div>
                    </div>
                </Card>
            ...
            <Modal
                ...
                title={`Edit ${editSection === 'personal' ? 'Personal Information' : editSection === 'safety' ? 'Emergency Contacts' : 'Trip Preferences'}`}
            >
                <div className={styles.editForm}>
                    ...
                    {editSection === 'trip' && (
                        <>
                            <div className={styles.formGroup}>
                                <label>Preferred Driver Type</label>
                                <input
                                    type="text"
                                    defaultValue={profileData.preferredDriverType}
                                    onChange={(e) => setProfileData({ ...profileData, preferredDriverType: e.target.value })}
                                />
                            </div>
                            <div className={styles.formGroup}>
                                ...
                                <input
                                    type="text"
                                    defaultValue={profileData.defaultPickup}
                                    onChange={(e) => setProfileData({ ...profileData, defaultPickup: e.target.value })}
                                />
                            </div>
                        </>
                    )}
